...
async def new_session(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    old_session_id = context.user_data.get("codex_session_id")
...
async def continue_session(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    user_id = update.effective_user.id
    settings: Settings = context.bot_data["settings"]
    codex_integration: CodexIntegration = context.bot_data.get("codex_integration")
    audit_logger: AuditLogger = context.bot_data.get("audit_logger")
...
async def change_directory(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        codex_integration: CodexIntegration = context.bot_data.get(
            "codex_integration"
        )
        ...
        if codex_integration:
            ...
            if existing_session:
                context.user_data["codex_session_id"] = existing_session.session_id
                resumed_session_info = (
